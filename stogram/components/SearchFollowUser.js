    ...
    <div className="relative" ref={dropdownRef}>
      <div className="flex items-center gap-2">
        <input
          ...
          placeholder="Search"
          className="px-4 py-2 outline outline-1 outline-purple-400 rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500 w-64 text-white bg-black text-lg w-full h-full"
        />
        <button
          onClick={handleSearch}
          disabled={isSearching || !searchQuery.trim()}
          className="px-4 py-2 bg-purple-400 text-white rounded-lg hover:bg-rose-400 cursor-pointer disabled:bg-purple-300 disabled:cursor-not-allowed transition-colors"
        >
      ...
      {showDropdown && searchResult && (
        <div 
          className="absolute top-full mt-2 left-0 bg-black text-white  rounded-lg shadow-xl z-[9999] min-w-[450px]"
            ...
            <div className="p-4">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-white font-mono truncate mt-1">
                    {searchResult.address}
                  </div>

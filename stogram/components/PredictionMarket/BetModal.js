        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-purple-500 pr-16"
                placeholder="6"
                required
                disabled={loading || isConfirmed}
              />
              <button
                ...
                className="absolute right-2 top-1/2 transform -translate-y-1/2 text-xs  text-purple-500 hover:text-rose-400 px-2 py-1 rounded disabled:opacity-50  cursor-pointer"
              >
                MAX
              </button>
            </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="flex-1 bg-white hover:bg-purple-500 hover:text-white disabled:bg-gray-300 text-black cursor-pointer font-bold py-2 px-4 rounded transition-colors"
            >
              Cancel
            </button>
            <button
